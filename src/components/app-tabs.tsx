...
export default function AppTabs() {
  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="workout/index">
        <NativeTabs.Trigger.Label>Entrenamiento</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
      ...
      <NativeTabs.Trigger name="statistics/index">
        <NativeTabs.Trigger.Label>Estadísticas</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/statistics.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
    </NativeTabs>
